...
Three Tableau dashboards were created to communicate the results from different business perspectives.

## Dashboard 1 — Marketing A/B Test Performance Dashboard

The main executive dashboard provides a high-level overview of campaign performance.
...
This dashboard is designed for a quick stakeholder-level understanding of the A/B test.
...
It helps identify hours with higher advertising activity and stronger conversion performance.
